...
- **Onglet Afflictions** — Les afflictions actives avec leur effet (reprises de l'aide de jeu du compagnon) ; un clic en retire une, « Ajouter une affliction » ouvre la liste des autres. L'info-bulle (i) d'une affliction, comme son icône dans la colonne de gauche, envoie sa règle dans le chat.
